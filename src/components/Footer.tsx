    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-light text-primary">Space</span>
            </div>
            <p className="text-sm text-gray-400 mb-4">
             A better way to work, connect and grow your business.
            </p>
          ...
          <div>
            ...
            <form className="flex">
              <input
                ...
                className="px-3 py-2 text-sm bg-gray-800 border border-gray-700 rounded-l-md focus:outline-none focus:ring-1 focus:ring-primary w-full"
              />
              <button
                type="submit"
                className="bg-primary text-white px-3 py-2 text-sm rounded-r-md hover:bg-primary/90 transition-colors"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-gray-400 flex flex-col md:flex-row justify-between items-center">
          <p>&copy; {currentYear} CoworkSpace. All rights reserved.</p>
